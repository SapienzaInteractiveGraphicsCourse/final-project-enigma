...
its doors and windows, control its lights, switch between several
camera views (orbit, free camera, driver view, drone view), while tracking your best lap time. A dashboard
...
\textbf{ENGINE} button in the instrument cluster to start the car, or press \textbf{E}, select
\textbf{D} in the gear selector, and use WASD drive.
